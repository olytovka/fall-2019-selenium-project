...
public class VytrackExcelDDTTests extends VytrackTestBase {
    ...
    //this test will get test data from data provider getUserData
    ...
    public Object[][] getData() throws IOException {
        ...
        // we have to read the excel file, put its contents into 2d and return
        ...
        // 1 <= rowCount -> including the last row
