...
public class OracleJDBCConnectionDemo {
    ...
    public void test() throws SQLException {
     ...
     DatabaseMetaData dmetaData =  connection.getMetaData();
        ...
        System.out.println(rmetaData.getColumnType(1));
        ...
        // get the name of tha last person
        resultSet.last();
        System.out.println(resultSet.getObject("first_name"));
        ...
        // Make another call to db and get the result
        resultSet = statement.executeQuery("select distinct salary from employees e1 "+
                "        where 2 = ("+
